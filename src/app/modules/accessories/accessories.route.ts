...
router.post("/create-accessory",auth(USER_ROLE.Admin),upload.single("file"),parseData,validateRequest(accessoryValidation), AccessoryControllers.createAccessoryInto)
...
router.patch('/update-accessory/:accessoryId',auth(USER_ROLE.Admin),upload.single("file"),parseData,AccessoryControllers.updateAccessory)
