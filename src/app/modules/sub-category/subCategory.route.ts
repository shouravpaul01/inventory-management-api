...
router.post(
  "/create-sub-category",auth(USER_ROLE.Admin),
...
router.patch('/update-sub-category/:subCategoryId',auth(USER_ROLE.Admin),validateRequest(SubCatValidationSchema),SubCatControllers.updateSubCategoryInto)
router.patch('/update-active-status/:subCategoryId',auth(USER_ROLE.Admin),SubCatControllers.updateSubCategoryStatus)
